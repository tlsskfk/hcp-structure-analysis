...
# merge two dataset
data_wide = merge(data_var,data_thick_scale, by = "ID")
data_wide = merge(data_wide,data_vol_scale, by = "ID")
...
data_50l$hemisphere = W.strs_selectbetweenpattern(data_50l$regions, NULL, '_',1,1)
data_50l$regionlvl1 = W.strs_selectbetweenpattern(data_50l$regions, '_', '_',1,-1)
data_50l$regionlvl2 = W.strs_selectbetweenpattern(data_50l$regions, '_', NULL,-1,1)


data_50l$regionlvl1b = W.strs_selectbetweenpattern(data_50l$regions, NULL, '_',1,-1)
data_50l$regionlvl2b = paste(data_50l$hemisphere, data_50l$regionlvl2, sep = '_')
...
saveRDS(data, file = './data_brms.RDS')
